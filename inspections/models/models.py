...
api_branches_names_blueprint = manager.create_api(Facilities, methods=['GET'], include_columns=['branch_name', 'address'], collection_name='branch_names', results_per_page=None)
